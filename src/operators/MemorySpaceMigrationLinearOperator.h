#ifndef included_MemorySpaceMigrationLinearOperator_H_
#define included_MemorySpaceMigrationLinearOperator_H_

#include "AMP/operators/LinearOperator.h"

namespace AMP::Operator {
/**
 * This operator serves as an adaptor for an existing LinearOperator, Op,
 ...
 * modification.
 */
class MemorySpaceMigrationLinearOperator : public LinearOperator
{
...
public:
    ...
    //! Constructor
    explicit MemorySpaceMigrationLinearOperator( std::shared_ptr<const OperatorParameters> params );

    //! Destructor
    virtual ~MemorySpaceMigrationLinearOperator() {}

    //! Return the name of the operator
    std::string type() const override { return "MemorySpaceMigrationLinearOperator"; };
