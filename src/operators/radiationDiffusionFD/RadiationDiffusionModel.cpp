...
void Manufactured_RadDifModel::getNormalVector( size_t boundaryID, size_t &normalComponent, double &normalSign ) const {
...
double Manufactured_RadDifModel::exactSolutionGradient2D( size_t component, double x, double y, size_t gradComponent ) const {
...
double Manufactured_RadDifModel::exactSolutionGradient3D( size_t component, double x, double y, double z, size_t gradComponent ) const {
