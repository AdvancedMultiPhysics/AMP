                           ...
                           std::shared_ptr<LinearAlgebra::Vector> f )
{
    ...
    AMP_INSIST( u->getVariable(), "LevelOperator::apply: u must have a variable" );
    AMP_INSIST( f->getVariable(), "LevelOperator::apply: f must have a variable" );
    AMP_INSIST( d_inputVariable, "LevelOperator::apply: operator must have an input variable" );
    AMP_INSIST( d_outputVariable, "LevelOperator::apply: operator must have an output variable" );
