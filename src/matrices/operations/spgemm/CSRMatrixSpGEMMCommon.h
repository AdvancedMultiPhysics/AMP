...
public:
    ...
    CSRMatrixSpGEMMCommon() = default;
    CSRMatrixSpGEMMCommon( std::shared_ptr<matrixdata_t> A_,
        ...
        : A( A_ ),
          ...
          d_stream( C->d_acceleration_context.getStream() )
    {
