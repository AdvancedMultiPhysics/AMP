...
void MatrixTests::VerifyAXPYMatrix( AMP::UnitTest *utils )
{
    ...
    auto vector1lhs   = matrix1->getInputVector();
    auto vector2lhs   = matrix2->getInputVector();
    auto vector1rhs   = matrix1->getInputVector();
    auto vector2rhs   = matrix2->getInputVector();
    auto vectorresult = matrix2->getInputVector();
...
void MatrixTests::VerifyCopyMatrix( AMP::UnitTest *utils )
{
    ...
    auto u1 = matrix1->getInputVector();
    auto v1 = matrix1->getInputVector();

    auto u2           = matrix2->getInputVector();
    auto v2           = matrix2->getInputVector();
    auto vectorresult = matrix2->getInputVector();
...
void MatrixTests::VerifyExtractDiagonal( AMP::UnitTest *utils )
{
    ...
    auto vector     = matrix->getInputVector();
...
void MatrixTests::VerifyMultMatrix( AMP::UnitTest *utils )
{
    ...
    matrix = getCopyMatrix( matrix );
    matrix->zero();
    auto vectorlhs = matrix->getInputVector();
    auto vectorrhs = matrix->getInputVector();
...
void MatrixTests::VerifyMatMultMatrix_IA( AMP::UnitTest *utils )
{
    ...
    auto x = matLap->getInputVector();
    auto y = matLap->getOutputVector();
    ...
    auto xp      = matProd->getInputVector();
    auto yp      = matProd->getOutputVector();
    xp->setToScalar( 1.0 );
    matProd->mult( xp, yp );
