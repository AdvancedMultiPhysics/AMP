...
public:
    ...
    create( std::shared_ptr<AMP::Solver::SolverStrategyParameters> params )
    {
    ...
    void apply( std::shared_ptr<const AMP::LinearAlgebra::Vector> bET_,
                std::shared_ptr<AMP::LinearAlgebra::Vector> ET_ ) override;
...
private:
     ...
     */
    void diffusionSolve( std::shared_ptr<const AMP::LinearAlgebra::Vector> bE,
     ...
     */
    void reactionSolve( std::shared_ptr<const AMP::LinearAlgebra::Vector> bE,
                        std::shared_ptr<const AMP::LinearAlgebra::Vector> bT,
                        std::shared_ptr<AMP::LinearAlgebra::Vector> E,
