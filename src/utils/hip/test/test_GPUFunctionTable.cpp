...
#ifdef AMP_USE_HIP
    AMP::Array<double, AMP::GPUFunctionTable<double>, AMP::HipManagedAllocator<double>> C;
    AMP::Array<double, AMP::GPUFunctionTable<double>, AMP::HipManagedAllocator<double>> D;
