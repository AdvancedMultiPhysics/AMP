...
inline char *sdkFindFilePath( const char *filename, const char *executable_path )
{
    ...
    // JIT source files)
    // The origin for the relative search may be the .exe file, a .bat file launching an .exe, a
    // browser .exe launching the .exe or .bat, etc
    const char *searchPath[] = {
        ...
        "../0_Simple/<executable_name>/data/",    // up 1 in tree, "/0_Simple/<executable_name>/"
                                                  // subdir
        "../1_Utilities/<executable_name>/data/", // up 1 in tree, "/1_Utilities/<executable_name>/"
                                                  // subdir
        "../2_Graphics/<executable_name>/data/",  // up 1 in tree, "/2_Graphics/<executable_name>/"
                                                  // subdir
        "../3_Imaging/<executable_name>/data/",   // up 1 in tree, "/3_Imaging/<executable_name>/"
                                                  // subdir
        "../4_Finance/<executable_name>/data/",   // up 1 in tree, "/4_Finance/<executable_name>/"
                                                  // subdir
        "../5_Simulations/<executable_name>/data/", // up 1 in tree,
                                                    // "/5_Simulations/<executable_name>/" subdir
        "../6_Advanced/<executable_name>/data/", // up 1 in tree, "/6_Advanced/<executable_name>/"
                                                 // subdir
        "../7_CUDALibraries/<executable_name>/data/", // up 1 in tree,
                                                      // "/7_CUDALibraries/<executable_name>/"
                                                      // subdir
        "../8_Android/<executable_name>/data/", // up 1 in tree, "/8_Android/<executable_name>/"
                                                // subdir
        ...
        "../../sandbox/<executable_name>/data/",     // up 2 in tree, "/sandbox/<executable_name>/"
                                                     // subdir
        "../../0_Simple/<executable_name>/data/",    // up 2 in tree, "/0_Simple/<executable_name>/"
                                                     // subdir
        "../../1_Utilities/<executable_name>/data/", // up 2 in tree,
                                                     // "/1_Utilities/<executable_name>/" subdir
        "../../2_Graphics/<executable_name>/data/",  // up 2 in tree,
                                                     // "/2_Graphics/<executable_name>/" subdir
        "../../3_Imaging/<executable_name>/data/", // up 2 in tree, "/3_Imaging/<executable_name>/"
                                                   // subdir
        "../../4_Finance/<executable_name>/data/", // up 2 in tree, "/4_Finance/<executable_name>/"
                                                   // subdir
        ...
        "../../7_CUDALibraries/<executable_name>/data/", // up 2 in tree,
                                                         // "/7_CUDALibraries/<executable_name>/"
                                                         // subdir
        "../../8_Android/<executable_name>/data/", // up 2 in tree, "/8_Android/<executable_name>/"
                                                   // subdir
        "../../samples/<executable_name>/data/",   // up 2 in tree, "/samples/<executable_name>/"
                                                   // subdir
        "../../../",                               // up 3 in tree
        "../../../src/<executable_name>/",         // up 3 in tree, "/src/<executable_name>/" subdir
        "../../../src/<executable_name>/data/",    // up 3 in tree, "/src/<executable_name>/data/"
                                                   // subdir
        ...
        "../../../sandbox/<executable_name>/data/",  // up 3 in tree,
                                                     // "/sandbox/<executable_name>/data/" subdir
        ...
        "../../../0_Simple/<executable_name>/data/", // up 3 in tree, "/0_Simple/<executable_name>/"
                                                     // subdir
        ...
        "../../../4_Finance/<executable_name>/data/",   // up 3 in tree,
                                                        // "/4_Finance/<executable_name>/" subdir
        ...
        "../../../1_Utilities/<executable_name>/", // up 3 in tree,
                                                   // "/1_Utilities/<executable_name>/" subdir
        "../../../2_Graphics/<executable_name>/",  // up 3 in tree, "/2_Graphics/<executable_name>/"
                                                   // subdir
        "../../../3_Imaging/<executable_name>/",   // up 3 in tree, "/3_Imaging/<executable_name>/"
                                                   // subdir
        "../../../4_Finance/<executable_name>/",   // up 3 in tree, "/4_Finance/<executable_name>/"
                                                   // subdir
        "../../../5_Simulations/<executable_name>/", // up 3 in tree,
                                                     // "/5_Simulations/<executable_name>/" subdir
        "../../../6_Advanced/<executable_name>/", // up 3 in tree, "/6_Advanced/<executable_name>/"
                                                  // subdir
        "../../../7_CUDALibraries/<executable_name>/", // up 3 in tree,
                                                       // "/7_CUDALibraries/<executable_name>/"
                                                       // subdir
        "../../../8_Android/<executable_name>/",    // up 3 in tree, "/8_Android/<executable_name>/"
                                                    // subdir
        "../../../samples/<executable_name>/data/", // up 3 in tree, "/samples/<executable_name>/"
                                                    // subdir
        ...
        "../../../../src/<executable_name>/data/", // up 4 in tree, "/src/<executable_name>/data/"
                                                   // subdir
        "../../../../src/<executable_name>/src/",  // up 4 in tree, "/src/<executable_name>/src/"
                                                   // subdir
        "../../../../src/<executable_name>/inc/",  // up 4 in tree, "/src/<executable_name>/inc/"
                                                   // subdir
        "../../../../sandbox/<executable_name>/",  // up 4 in tree, "/sandbox/<executable_name>/"
                                                   // subdir
        ...
        "../../../../0_Simple/<executable_name>/data/", // up 4 in tree,
                                                        // "/0_Simple/<executable_name>/" subdir
        ...
        "../../../../2_Graphics/<executable_name>/",  // up 4 in tree,
                                                      // "/2_Graphics/<executable_name>/" subdir
        "../../../../3_Imaging/<executable_name>/", // up 4 in tree, "/3_Imaging/<executable_name>/"
                                                    // subdir
        "../../../../4_Finance/<executable_name>/", // up 4 in tree, "/4_Finance/<executable_name>/"
                                                    // subdir
        ...
        "../../../../7_CUDALibraries/<executable_name>/", // up 4 in tree,
                                                          // "/7_CUDALibraries/<executable_name>/"
                                                          // subdir
        "../../../../8_Android/<executable_name>/", // up 4 in tree, "/8_Android/<executable_name>/"
                                                    // subdir
        "../../../../samples/<executable_name>/data/", // up 4 in tree,
                                                       // "/samples/<executable_name>/" subdir
        ...
        "../../../../../src/<executable_name>/data/", // up 5 in tree,
                                                      // "/src/<executable_name>/data/" subdir
        "../../../../../src/<executable_name>/src/",  // up 5 in tree, "/src/<executable_name>/src/"
                                                      // subdir
        "../../../../../src/<executable_name>/inc/",  // up 5 in tree, "/src/<executable_name>/inc/"
                                                      // subdir
        "../../../../../sandbox/<executable_name>/",  // up 5 in tree, "/sandbox/<executable_name>/"
                                                      // subdir
