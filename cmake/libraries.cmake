...
MACRO( CONFIGURE_AMP )
    ...
    IF ( AMP_DATA OR AMP_DATA_URL )
        ...
        ELSEIF ( EXISTS "${AMP_DATA}" )
            ...
            GET_FILENAME_COMPONENT( AMP_DATA2 "${AMP_DATA}" NAME_WE )
            IF ( EXISTS "${AMP_INSTALL_DIR}/AMP-Data" )
                SET( AMP_DATA "${AMP_INSTALL_DIR}/AMP-Data" )
            ELSEIF ( EXISTS "${AMP_INSTALL_DIR}/${AMP_DATA2}" )
                SET( AMP_DATA "${AMP_INSTALL_DIR}/${AMP_DATA2}" )
            ELSE()
                MESSAGE( FATAL_ERROR "Error unpacking tar file ${AMP_DATA}" )
            ENDIF()
        ENDIF()
    ENDIF()
    IF ( NOT ONLY_BUILD_DOCS AND NOT AMP_DATA )
